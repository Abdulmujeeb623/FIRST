...
if($password!==$password2){
	...
	{
	if($stmt= $conn->prepare("INSERT INTO mine (firstname, lastname, userame, username2, phonenumber, gender, birthday, 
	email1, email2, password1, password2) values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"))
	{
	$stmt->bind_param("ssssissssss",$name, $nname, $username, $username, $number, $gender, $birthday,
	 $email, $email, $password2, $password2);
